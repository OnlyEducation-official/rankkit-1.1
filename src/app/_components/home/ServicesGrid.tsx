...
const services: Service[] = [
  {
    ...
    points: ["Full-funnel strategy", "Ads + landing page optimization", "Tracking, CRO & reporting"],
  ...
  },
  {
    ...
    points: ["Campaign strategy & planning", "Creative execution across platforms", "Audience targeting & funnel alignment", "Real-time optimization & reporting"],
  ...
  },
  {
    ...
    points: ["Brand positioning & messaging", "Content-driven brand storytelling", "Platform-specific promotion strategies", "Reach, engagement & recall tracking"],
    icon: <PeopleAltRoundedIcon />,
  ...
  return (
    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative" }}>
        ...
        <Grid container spacing={3} alignItems="flex-end">
          <Grid item xs={12} md={8}>
            <Stack spacing={1.5}>
              ...
              >
                Choose a single service or combine them into a complete growth system.
                We help brands improve visibility, increase conversions, and build revenue
                using performance marketing, SEO, conversion-first websites, and influencer campaigns.
              </Typography>
            </Stack>
          </Grid>
        ...
        >
          Digital marketing agency services including performance marketing, SEO services,
          website development, and influencer marketing to improve conversions and revenue.
        </Typography>
      </Container>
    </Box>
  );
